...
This is the new modular entry point that uses the refactored code structure.
For the legacy single-file version, run main.py instead.
...
def main():
    ...
    try:
        ...
        # Use the new modular MainWindow
